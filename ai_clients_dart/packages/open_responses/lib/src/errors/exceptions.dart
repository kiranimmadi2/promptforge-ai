...
sealed class OpenResponsesException implements Exception {
  ...
  @override
  String toString() => 'OpenResponsesException: $message';
}
...
class ValidationException extends OpenResponsesException {
  @override
  final String message;
...
class TimeoutException extends OpenResponsesException {
  @override
  final String message;
...
class AbortedException extends OpenResponsesException {
  @override
  final String message;
