...
void main() {
  group('ModerationResult', () {
    ...
    group('fromJson', () {
      test('should parse complete moderation result', () {
    ...
    group('toJson', () {
      test('should serialize moderation result', () {
        ...
        expect(categories['pii'], isFalse);
        final categoryScores = json['category_scores'] as Map<String, dynamic>;
        expect(categoryScores['sexual'], 0.1);
      });
    });
    ...
    group('equality', () {
      test('should be equal when categoryScores are the same', () {
        const result1 = ModerationResult(
          categories: {'sexual': true},
          categoryScores: testCategoryScores,
        );
        const result2 = ModerationResult(
          categories: {'sexual': true},
          categoryScores: testCategoryScores,
        );
    ...
    group('toString', () {
      test('should return a meaningful string representation', () {
        ...
        expect(result.toString(), contains('ModerationResult'));
