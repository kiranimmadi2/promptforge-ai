...
import 'workflow_task_failed_attributes.dart';

/// Workflow task failed event.
@immutable
class WorkflowTaskFailedResponse {
  ...
  final WorkflowTaskFailedAttributes attributes;

  /// Creates a [WorkflowTaskFailedResponse].
  const WorkflowTaskFailedResponse({
    required this.eventId,
    required this.eventTimestamp,
    this.eventType = 'WORKFLOW_TASK_FAILED',
  ...
  /// Creates a [WorkflowTaskFailedResponse] from JSON.
  factory WorkflowTaskFailedResponse.fromJson(Map<String, dynamic> json) =>
      WorkflowTaskFailedResponse(
        eventId: json['event_id'] as String? ?? '',
        eventTimestamp: json['event_timestamp'] as int? ?? 0,
        eventType: json['event_type'] as String? ?? 'WORKFLOW_TASK_FAILED',
        ...
        attributes: WorkflowTaskFailedAttributes.fromJson(
  ...
  WorkflowTaskFailedResponse copyWith({
    String? eventId,
    int? eventTimestamp,
    String? eventType,
    ...
    String? workflowName,
    WorkflowTaskFailedAttributes? attributes,
  }) {
    return WorkflowTaskFailedResponse(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! WorkflowTaskFailedResponse) return false;
