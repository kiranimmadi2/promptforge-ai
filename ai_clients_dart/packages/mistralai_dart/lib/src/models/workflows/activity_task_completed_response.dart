...
import 'activity_task_completed_attributes_response.dart';

/// Activity task completed event.
@immutable
class ActivityTaskCompletedResponse {
  ...
  final ActivityTaskCompletedAttributesResponse attributes;

  /// Creates a [ActivityTaskCompletedResponse].
  const ActivityTaskCompletedResponse({
    required this.eventId,
    required this.eventTimestamp,
    this.eventType = 'ACTIVITY_TASK_COMPLETED',
  ...
  /// Creates a [ActivityTaskCompletedResponse] from JSON.
  factory ActivityTaskCompletedResponse.fromJson(Map<String, dynamic> json) =>
      ActivityTaskCompletedResponse(
        eventId: json['event_id'] as String? ?? '',
        eventTimestamp: json['event_timestamp'] as int? ?? 0,
        eventType: json['event_type'] as String? ?? 'ACTIVITY_TASK_COMPLETED',
        ...
        attributes: ActivityTaskCompletedAttributesResponse.fromJson(
  ...
  ActivityTaskCompletedResponse copyWith({
    String? eventId,
    int? eventTimestamp,
    String? eventType,
    ...
    String? workflowName,
    ActivityTaskCompletedAttributesResponse? attributes,
  }) {
    return ActivityTaskCompletedResponse(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! ActivityTaskCompletedResponse) return false;
