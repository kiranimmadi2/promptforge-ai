...
import 'custom_task_started_attributes_response.dart';

/// Custom task started event.
@immutable
class CustomTaskStartedResponse {
  ...
  final CustomTaskStartedAttributesResponse attributes;

  /// Creates a [CustomTaskStartedResponse].
  const CustomTaskStartedResponse({
    required this.eventId,
    required this.eventTimestamp,
    this.eventType = 'CUSTOM_TASK_STARTED',
  ...
  /// Creates a [CustomTaskStartedResponse] from JSON.
  factory CustomTaskStartedResponse.fromJson(Map<String, dynamic> json) =>
      CustomTaskStartedResponse(
        eventId: json['event_id'] as String? ?? '',
        eventTimestamp: json['event_timestamp'] as int? ?? 0,
        eventType: json['event_type'] as String? ?? 'CUSTOM_TASK_STARTED',
        ...
        attributes: CustomTaskStartedAttributesResponse.fromJson(
  ...
  CustomTaskStartedResponse copyWith({
    String? eventId,
    int? eventTimestamp,
    String? eventType,
    ...
    String? workflowName,
    CustomTaskStartedAttributesResponse? attributes,
  }) {
    return CustomTaskStartedResponse(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! CustomTaskStartedResponse) return false;
