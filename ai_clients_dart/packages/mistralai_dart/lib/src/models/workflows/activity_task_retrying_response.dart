...
import 'activity_task_retrying_attributes.dart';

/// Activity task retrying event.
@immutable
class ActivityTaskRetryingResponse {
  ...
  final ActivityTaskRetryingAttributes attributes;

  /// Creates a [ActivityTaskRetryingResponse].
  const ActivityTaskRetryingResponse({
    required this.eventId,
    required this.eventTimestamp,
    this.eventType = 'ACTIVITY_TASK_RETRYING',
  ...
  /// Creates a [ActivityTaskRetryingResponse] from JSON.
  factory ActivityTaskRetryingResponse.fromJson(Map<String, dynamic> json) =>
      ActivityTaskRetryingResponse(
        eventId: json['event_id'] as String? ?? '',
        eventTimestamp: json['event_timestamp'] as int? ?? 0,
        eventType: json['event_type'] as String? ?? 'ACTIVITY_TASK_RETRYING',
        ...
        attributes: ActivityTaskRetryingAttributes.fromJson(
  ...
  ActivityTaskRetryingResponse copyWith({
    String? eventId,
    int? eventTimestamp,
    String? eventType,
    ...
    String? workflowName,
    ActivityTaskRetryingAttributes? attributes,
  }) {
    return ActivityTaskRetryingResponse(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! ActivityTaskRetryingResponse) return false;
