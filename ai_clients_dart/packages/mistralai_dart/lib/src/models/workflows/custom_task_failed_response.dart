...
import 'custom_task_failed_attributes.dart';

/// Custom task failed event.
@immutable
class CustomTaskFailedResponse {
  ...
  final CustomTaskFailedAttributes attributes;

  /// Creates a [CustomTaskFailedResponse].
  const CustomTaskFailedResponse({
    required this.eventId,
    required this.eventTimestamp,
    this.eventType = 'CUSTOM_TASK_FAILED',
  ...
  /// Creates a [CustomTaskFailedResponse] from JSON.
  factory CustomTaskFailedResponse.fromJson(Map<String, dynamic> json) =>
      CustomTaskFailedResponse(
        eventId: json['event_id'] as String? ?? '',
        eventTimestamp: json['event_timestamp'] as int? ?? 0,
        eventType: json['event_type'] as String? ?? 'CUSTOM_TASK_FAILED',
        ...
        attributes: CustomTaskFailedAttributes.fromJson(
  ...
  CustomTaskFailedResponse copyWith({
    String? eventId,
    int? eventTimestamp,
    String? eventType,
    ...
    String? workflowName,
    CustomTaskFailedAttributes? attributes,
  }) {
    return CustomTaskFailedResponse(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! CustomTaskFailedResponse) return false;
