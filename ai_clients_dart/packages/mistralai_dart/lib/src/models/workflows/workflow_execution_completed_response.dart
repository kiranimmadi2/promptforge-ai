...
import 'workflow_execution_completed_attributes_response.dart';

/// Workflow execution completed event.
@immutable
class WorkflowExecutionCompletedResponse {
  ...
  final WorkflowExecutionCompletedAttributesResponse attributes;

  /// Creates a [WorkflowExecutionCompletedResponse].
  const WorkflowExecutionCompletedResponse({
    required this.eventId,
    required this.eventTimestamp,
    this.eventType = 'WORKFLOW_EXECUTION_COMPLETED',
  ...
  /// Creates a [WorkflowExecutionCompletedResponse] from JSON.
  factory WorkflowExecutionCompletedResponse.fromJson(
    Map<String, dynamic> json,
  ) => WorkflowExecutionCompletedResponse(
    eventId: json['event_id'] as String? ?? '',
    eventTimestamp: json['event_timestamp'] as int? ?? 0,
    eventType: json['event_type'] as String? ?? 'WORKFLOW_EXECUTION_COMPLETED',
    ...
    attributes: WorkflowExecutionCompletedAttributesResponse.fromJson(
  ...
  WorkflowExecutionCompletedResponse copyWith({
    String? eventId,
    int? eventTimestamp,
    String? eventType,
    ...
    String? workflowName,
    WorkflowExecutionCompletedAttributesResponse? attributes,
  }) {
    return WorkflowExecutionCompletedResponse(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! WorkflowExecutionCompletedResponse) return false;
