...
class PostJudgeInSchema {
  ...
  /// Creates a [PostJudgeInSchema] from JSON.
  factory PostJudgeInSchema.fromJson(Map<String, dynamic> json) =>
      PostJudgeInSchema(
  ...
  bool operator ==(Object other) {
    ...
    if (other is! PostJudgeInSchema) return false;
  ...
  @override
  String toString() => 'PostJudgeInSchema(name: $name, modelName: $modelName)';
}
